 ...
 */
public class CompleteRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.intalio.bpms.workflow.taskManagementServices20051109.CompleteRequestDocument
{
    
    public CompleteRequestDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName COMPLETEREQUEST$0 = 
        new javax.xml.namespace.QName("http://www.intalio.com/BPMS/Workflow/TaskManagementServices-20051109/", "completeRequest");
    
    
    /**
     * Gets the "completeRequest" element
     */
    public com.intalio.bpms.workflow.taskManagementServices20051109.CompleteRequestDocument.CompleteRequest getCompleteRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.intalio.bpms.workflow.taskManagementServices20051109.CompleteRequestDocument.CompleteRequest target = null;
            target = (com.intalio.bpms.workflow.taskManagementServices20051109.CompleteRequestDocument.CompleteRequest)get_store().find_element_user(COMPLETEREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCompleteRequest(com.intalio.bpms.workflow.taskManagementServices20051109.CompleteRequestDocument.CompleteRequest completeRequest)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.intalio.bpms.workflow.taskManagementServices20051109.CompleteRequestDocument.CompleteRequest)get_store().add_element_user(COMPLETEREQUEST$0);
            }
            target.set(completeRequest);
        }
    }
     ...
     */
    public com.intalio.bpms.workflow.taskManagementServices20051109.CompleteRequestDocument.CompleteRequest addNewCompleteRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class CompleteRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.intalio.bpms.workflow.taskManagementServices20051109.CompleteRequestDocument.CompleteRequest
    {
        
        public CompleteRequestImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
