 ...
 */
package org.intalio.deploy.deployment.utils;
...
public class DeploymentServiceRegister {
    ...
    private boolean _debug = System.getProperty("org.intalio.deploy.deployment.utils.DeploymentServiceRegister", "no_debug").equalsIgnoreCase("debug");
